...
Based on the Pit Menu (by NAGP MadMac) I have developed this app with the following characteristics:
...
V1.7.1
- Changed Hotkey to F10 since a letter was affecting the chat.

V1.7
- Added Hotkey to cycle between Presets. 

V1.6
- Added option on the PitConfig.ini to ignore window mode detection (usefull on some PLP monitor setups).

V1.5.1
- Corrected a bug on the pit position initialization (Thanks to AdderSwim). 
